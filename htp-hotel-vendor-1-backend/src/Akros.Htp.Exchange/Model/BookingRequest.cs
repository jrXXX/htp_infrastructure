...
namespace Akros.Htp.Exchange.Model
{
    ...
    public partial class BookingRequest : IEquatable<BookingRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public BookingRequest(DateTime dateFrom = default(DateTime), DateTime dateTo = default(DateTime), Room room = default(Room))
        {
        ...
        {
            return this.Equals(input as BookingRequest);
        }

        /// <summary>
        /// Returns true if BookingRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BookingRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BookingRequest input)
        {
            if (input == null)
                return false;
