...
insert into facility_assignment (facility_id, hotel_id) values ((select id from facility where name = 'SPA'), (select id from hotel where name = 'H24'));
...
insert into room (name, type, price, HOTEL_ID) values ('101','KING', 125, (select ID from hotel where name = 'H24'));
insert into room (name, type, price, HOTEL_ID) values ('102','QUEEN', 170, (select ID from hotel where name = 'H24'));
insert into room (name, type, price, HOTEL_ID) values ('103','DOUBLE', 250, (select ID from hotel where name = 'H24'));
